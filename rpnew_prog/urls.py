...
urlpatterns = [
    ...
    path('accounts/login/', user_views.FrontLoginView.as_view(),
        name='front_login'),
    path('accounts/password_reset/', user_views.FrontPasswordResetView.as_view(),
        name='front_password_reset'),
    path('accounts/password_reset/done/', user_views.TemplateResetView.as_view(),
